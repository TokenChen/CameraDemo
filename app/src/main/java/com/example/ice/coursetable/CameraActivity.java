...
public class CameraActivity extends AppCompatActivity {
    ...
    private void changeCamera() {
        try {
            ...
            if (mCameraID.equals(CameraMetadata.LENS_FACING_FRONT)) {
                mCameraID = String.valueOf(CameraMetadata.LENS_FACING_BACK);
            } else {
                mCameraID = String.valueOf(CameraMetadata.LENS_FACING_FRONT);
            }
        ...
        mImageReader.setOnImageAvailableListener(
                new ImageReader.OnImageAvailableListener() { //可以在这里处理拍照得到的临时照片 例如，写入本地
                    ...
                    public void onImageAvailable(ImageReader reader) {
                        ...
                        if (bitmap != null) {
                            if (Objects.equals(mCameraID, CameraMetadata.LENS_FACING_FRONT)) {
                                //前置摄像头拍的要先旋转180度
